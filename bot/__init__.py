...
try:
    ...
    TGH_THUMB = 'https://telegra.ph/file/5793f76d2f83ccb69991c.jpg'
...
try:
    ...
    START_BTN1_URL = 'https://t.me/Collection_MovieTerbaik'
...
try:
    ...
    START_BTN2_URL = 'https://t.me/RequestMovie84'
try:
...
try:
    ...
    if len(AUTHOR_URL) == 0:
        AUTHOR_URL = 'https://t.me/Collection_MovieTerbaik'
except KeyError:
    AUTHOR_URL = 'https://t.me/Collection_MovieTerbaik'
try:
